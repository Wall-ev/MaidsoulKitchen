...
import com.catbert.tlma.api.task.v1.cook.INormalCook;
...
public abstract class TaskNormalCook<B extends BlockEntity, R extends Recipe<? extends Container>> implements ITaskCook<B, R>, INormalCook<B, R> {
    @Override
