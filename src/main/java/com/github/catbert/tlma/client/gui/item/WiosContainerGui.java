...
@IPNIgnore
public class WiosContainerGui extends AbstractContainerScreen<WiosContainer> {
    ...
    protected void init() {
        ...
        ImageButton configButton = new ImageButton(leftPos + 136, topPos + 44, 16, 16, 208, 0, 16,
                MAIN, 256, 256, buttons -> getMinecraft().setScreen(new WiiosConfigSlotGui(menu.getWirelessIO())));
