package com.github.wallev.maidsoulkitchen.handler.rule.crockpot;
...
public class CpCookingRecRuleSerializer extends AbstractCookRecRuleSerializer<CrockPotCookingRecipe, CrockPotCookingRec> {

    public CpCookingRecRuleSerializer() {
