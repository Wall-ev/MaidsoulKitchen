package com.github.wallev.maidsoulkitchen.handler.initializer.drinkbeer.ingredient;
...
public class DbBrewingRecIngredientSerializer extends AbstractCookRecIngredientSerializer<BrewingRecipe, DefaultCookRec<BrewingRecipe>> {

    public DbBrewingRecIngredientSerializer() {
        super(RecipeRegistry.RECIPE_TYPE_BREWING.get());
    }

    @Override
    public boolean processInvIngres(DefaultCookRec<BrewingRecipe> cookRec, Map<Item, Integer> available, List<Item> invIngredient, Map<Item, Integer> itemTimes, boolean[] single) {
