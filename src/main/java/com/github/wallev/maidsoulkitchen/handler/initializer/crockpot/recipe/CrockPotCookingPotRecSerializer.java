package com.github.wallev.maidsoulkitchen.handler.initializer.crockpot.recipe;
...
public class CrockPotCookingPotRecSerializer extends AbstractCookRecInitializer<CrockPotCookingRecipe> {
...
//    @todo optimize
    ...
    protected void initialize(Level level) {
        ...
        for (CrockPotCookingRecipe crockPotCookingRecipe : this.recs) {
        ...
        for (CrockPotCookingRecipe rec : this.recs) {
            ...
            this.cookRecs.add(crockPotCookingRec);
