...
public abstract class TikiBarBlockEntityMixin implements ILdCbeAccessor<TikiBarBlockEntity, TikiBarRecipe> {

    @Shadow
    protected abstract boolean canCraft(TikiBarRecipe recipe, RegistryAccess access);

    @Override
    public boolean tlmk$canCraft(TikiBarRecipe rec, RegistryAccess access) {
