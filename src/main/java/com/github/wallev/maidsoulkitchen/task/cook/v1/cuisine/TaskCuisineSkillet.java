...
import com.github.wallev.maidsoulkitchen.task.ai.MaidCuisineMakeTask;
...
public class TaskCuisineSkillet implements ICookTask<CuisineSkilletBlockEntity, BaseCuisineRecipe<?>> {
    @Override
    ...
    public ResourceLocation getUid() {
        return TaskInfo.CUISINE_SKILLET.uid;
    }
