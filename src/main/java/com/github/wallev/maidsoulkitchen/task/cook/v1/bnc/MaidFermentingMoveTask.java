...
public class MaidFermentingMoveTask extends MaidCheckRateTask {
    ...
    private final TaskBncKeyOfficeV2 task;
    private final KegFermentingRecipesManager maidRecipesManager;
    protected int verticalSearchStart;

    public MaidFermentingMoveTask(TaskBncKeyOfficeV2 task, KegFermentingRecipesManager maidRecipesManager) {
        this(task, 0.5f, 2, maidRecipesManager);
    }

    public MaidFermentingMoveTask(TaskBncKeyOfficeV2 task, float movementSpeed, int verticalSearchRange, KegFermentingRecipesManager maidRecipesManager) {
