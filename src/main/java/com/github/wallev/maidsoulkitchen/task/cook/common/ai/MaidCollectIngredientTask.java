...
//
//public class MaidCollectIngredientTask<B extends BlockEntity, R extends Recipe<? extends Container>> extends Behavior<EntityMaid> implements VBehaviorControl {
//    private final ICookTask<B, R> task;
//    private final MaidRecipesManager<R> maidRecipesManager;
//
//    public MaidCollectIngredientTask(ICookTask<B, R> task, MaidRecipesManager<R> maidRecipesManager) {
