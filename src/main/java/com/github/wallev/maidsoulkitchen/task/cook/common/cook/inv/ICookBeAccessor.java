...
public interface ICookBeAccessor {
    ...
    default <R extends Recipe<? extends Container>> boolean kl$canCook(IItemHandlerModifiable inv, Function<RecipeWrapper, Optional<R>> recMatchGet, Predicate<R> recCanCook) {
