...
public record ActionCookDataRecsPackage(int entityId, ResourceLocation dataKey, List<String> recs, boolean add) {

    public static void encode(ActionCookDataRecsPackage message, FriendlyByteBuf buf) {
    ...
    public static ActionCookDataRecsPackage decode(FriendlyByteBuf buf) {
        ...
        return new ActionCookDataRecsPackage(entityId, dataKey, recs, add);
    }

    public static void handle(ActionCookDataRecsPackage message, Supplier<NetworkEvent.Context> contextSupplier) {
