package com.github.wallev.maidsoulkitchen.client.renderer.entity.layer.banner.herbalbrews;
...
@TaskClassAnalyzer(TaskInfo.LAYER_HERBALBREWS)
@OnlyIn(Dist.CLIENT)
public class LayerHerbalbrewsBannerRender implements IBannerRenderer {
