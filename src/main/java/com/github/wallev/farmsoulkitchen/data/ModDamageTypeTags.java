...
public class ModDamageTypeTags extends TagsProvider<DamageType> {
    public static final TagKey<DamageType> DAMAGES_BURN = TagKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(FarmsoulKitchen.MOD_ID, "damages_burn"));
    ...
    public ModDamageTypeTags(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pLookupProvider, @Nullable ExistingFileHelper existingFileHelper) {
        super(pOutput, Registries.DAMAGE_TYPE, pLookupProvider, FarmsoulKitchen.MOD_ID, existingFileHelper);
    }
