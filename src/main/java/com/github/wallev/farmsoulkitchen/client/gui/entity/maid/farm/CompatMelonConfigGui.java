...
import com.github.wallev.farmsoulkitchen.client.gui.widget.button.NavCompatMelonConfigButton;
...
public class CompatMelonConfigGui extends MaidTaskConfigGui<CompatMelonConfigContainer> {
    ...
    private void addNavCompatMelonConfigButton() {
        ...
        MutableComponent translatable = Component.translatable("gui.farmsoulkitchen.config.global_config").withStyle(ChatFormatting.ITALIC);
