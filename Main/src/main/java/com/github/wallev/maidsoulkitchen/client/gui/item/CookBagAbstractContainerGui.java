...
public abstract class CookBagAbstractContainerGui<T extends CookBagAbstractContainer> extends AbstractContainerScreen<T> {
    protected static final ResourceLocation CONTAINER_BACKGROUND = VResourceLocation.of(MaidsoulKitchen.MOD_ID, "textures/gui/culinary_hub_container.png");
    protected static final ResourceLocation CONFIG_BACKGROUND = VResourceLocation.of(MaidsoulKitchen.MOD_ID, "textures/gui/culinary_hub_config.png");
