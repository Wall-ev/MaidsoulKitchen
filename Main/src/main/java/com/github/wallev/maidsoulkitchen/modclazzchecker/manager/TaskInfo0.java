...
public enum TaskInfo0 implements ITaskInfo<Mods> {
    /**
    ...
    YHC_FERMENTATION_TANK("yhc_fermentation_tank",
            ...
            true,
            Mods.YHCF),
    YHC_FERMENTATION_TANK_LEGACY(TaskInfo0.YHC_FERMENTATION_TANK, Mods.YHCD_LEGACY),
    ...
    KK_BREW_BARREL("kk_brew_barrel",
            ...
            Mods.KK_NEW,
            true),
    KK_BREW_BARREL_LEGACY(TaskInfo0.KK_BREW_BARREL, Mods.KK_LEGACY),
    @TaskModule(type = TaskModule.Type.KITCHEN_MODULE)
...
//    MSM_YHCF_KETTLE(MSM_YHC_KETTLE, Mods.YHCF),
    ...
    ;
    public static final TaskInfo0[] VALUES = values();
    public static final Codec<TaskInfo0> CODEC = EnumCodecUtil.fromEnum(() -> VALUES);
    ...
    private final List<TaskInfo0> dependTasks;
    private final List<Mods> dependMods;

    // -----------------------------------------------------------TaskInfo----------------------------------------------------------------//
    TaskInfo0(ResourceLocation uid, Mods bindMod, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, TaskInfo0... dependTasks) {
        this.uid = uid;
    ...
    TaskInfo0(ResourceLocation uid, Mods bindMod, TaskInfo0... dependTasks) {
        this.uid = uid;
        this.bindMod = bindMod;
    ...
    TaskInfo0(ResourceLocation uid, Mods bindMod, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, @Nullable Mods secondMod, TaskInfo0... dependTasks) {
        this.uid = uid;
        this.bindMod = bindMod;
        this.bindConfig = () -> bindConfig.get().get();
        this.dependTasks = List.of(dependTasks);
    ...
    TaskInfo0(ResourceLocation uid, Mods bindMod, @Nullable Mods secondMod, TaskInfo0... dependTasks) {
        this.uid = uid;
        this.bindMod = bindMod;
        this.bindConfig = () -> TaskRegisterConfig.enabled(this.uid);
        this.dependTasks = List.of(dependTasks);
    ...
    TaskInfo0(String oldName, String uid, Mods bindMod, boolean concatModId, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, TaskInfo0... dependTasks) {
    ...
    TaskInfo0(String oldName, String uid, Mods bindMod, boolean concatModId, TaskInfo0... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, uid, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> TaskRegisterConfig.enabled(this.uid);
    ...
    TaskInfo0(String oldName, String uid, Mods bindMod, boolean concatModId, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, @Nullable Mods secondMod, TaskInfo0... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, uid, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> bindConfig.get().get();
    ...
    TaskInfo0(String oldName, String uid, Mods bindMod, boolean concatModId, @Nullable Mods secondMod, TaskInfo0... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, uid, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> TaskRegisterConfig.enabled(this.uid);
    ...
    TaskInfo0(String oldName, String uid, Mods bindMod, boolean concatModId, Config bindConfig, TaskInfo0... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, uid, bindMod, concatModId);
        this.bindMod = bindMod;
    ...
    TaskInfo0(String oldName, String uid, Mods bindMod, boolean concatModId, Config bindConfig, @Nullable Mods secondMod, TaskInfo0... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, uid, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> bindConfig.canLoad();
    ...
    TaskInfo0(String oldName, String blockId, String recipeId, Mods bindMod, boolean concatModId, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, TaskInfo0... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
    ...
    TaskInfo0(String oldName, String blockId, String recipeId, Mods bindMod, boolean concatModId, TaskInfo0... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, blockId + "_" + recipeId, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> TaskRegisterConfig.enabled(this.uid);
    ...
    TaskInfo0(String oldName, String blockId, String recipeId, Mods bindMod, boolean concatModId, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, @Nullable Mods secondMod, TaskInfo0... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, blockId + "_" + recipeId, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> bindConfig.get().get();
    ...
    TaskInfo0(String oldName, String blockId, String recipeId, Mods bindMod, boolean concatModId, @Nullable Mods secondMod, TaskInfo0... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, blockId + "_" + recipeId, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> TaskRegisterConfig.enabled(this.uid);
    ...
    TaskInfo0(String oldName, String blockId, String recipeId, Mods bindMod, boolean concatModId, Config bindConfig, TaskInfo0... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, blockId + "_" + recipeId, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> bindConfig.canLoad();
    ...
    TaskInfo0(String oldName, String blockId, String recipeId, Mods bindMod, boolean concatModId, Config bindConfig, @Nullable Mods secondMod, TaskInfo0... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, blockId + "_" + recipeId, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> bindConfig.canLoad();
    ...
    TaskInfo0(String uid, Mods bindMod, boolean concatModId, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, TaskInfo0... dependTasks) {
        this("", uid, bindMod, concatModId, bindConfig, dependTasks);
    }

    TaskInfo0(String uid, Mods bindMod, boolean concatModId, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, @Nullable Mods secondMod, TaskInfo0... dependTasks) {
        this("", uid, bindMod, concatModId, bindConfig, secondMod, dependTasks);
    }

    TaskInfo0(String uid, Mods bindMod, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, TaskInfo0... dependTasks) {
        this(uid, bindMod, false, bindConfig, dependTasks);
    }

    TaskInfo0(String uid, Mods bindMod, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, @Nullable Mods secondMod, TaskInfo0... dependTasks) {
        this(uid, bindMod, false, bindConfig, secondMod, dependTasks);
    }

    TaskInfo0(String uid, Mods bindMod, boolean concatModId, Config bindConfig, TaskInfo0... dependTasks) {
        this.uid = convertUid(oldName, uid, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> bindConfig.canLoad();
        this.dependTasks = List.of(dependTasks);
    ...
    TaskInfo0(String uid, Mods bindMod, boolean concatModId, Config bindConfig, @Nullable Mods secondMod, TaskInfo0... dependTasks) {
        this.uid = convertUid(oldName, uid, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> bindConfig.canLoad();
        this.dependTasks = List.of(dependTasks);
    ...
    TaskInfo0(String uid, Mods bindMod, boolean concatModId, TaskInfo0... dependTasks) {
        this.uid = convertUid(oldName, uid, bindMod, concatModId);
        this.bindMod = bindMod;
    ...
    TaskInfo0(String uid, Mods bindMod, boolean concatModId, @Nullable Mods secondMod, TaskInfo0... dependTasks) {
        this.uid = convertUid(oldName, uid, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> true;
        this.dependTasks = List.of(dependTasks);
    ...
    TaskInfo0(String uid, Mods bindMod, Config bindConfig, TaskInfo0... dependTasks) {
        this(uid, bindMod, false, bindConfig, dependTasks);
    }


    TaskInfo0(String uid, Mods bindMod, Config bindConfig, @Nullable Mods secondMod, TaskInfo0... dependTasks) {
        this(uid, bindMod, false, bindConfig, secondMod, dependTasks);
    }

    TaskInfo0(String uid, Mods bindMod, TaskInfo0... dependTasks) {
        this(uid, bindMod, false, dependTasks);
    }

    TaskInfo0(String uid, Mods bindMod, @Nullable Mods secondMod, TaskInfo0... dependTasks) {
     ...
     */
    TaskInfo0(TaskInfo0 parentTaskInfo, Mods legacyMod) {
...
//        return VResourceLocation.createMod(oldName);
    ...
    public static TaskInfo0 by(String key) {
        return TaskInfo0.valueOf(key);
    }

    @Nullable
    public static TaskInfo0 by(ResourceLocation taskUid) {
        for (TaskInfo0 value : TaskInfo0.values()) {
    ...
    public boolean dependCanLoad() {
        return this.dependTasks.stream().allMatch(TaskInfo0::canLoadWithoutCheckClazz) && this.dependMods.stream().allMatch(Mods::versionLoad);
    }
