package com.github.wallev.maidsoulkitchen.client.renderer.entity.layer.banner.beachparty;
...
@TaskClassAnalyzer(TaskInfo.LAYER_BEACHPARTY)
@OnlyIn(Dist.CLIENT)
public class LayerBeachpartyBannerRender implements IBannerRenderer {
