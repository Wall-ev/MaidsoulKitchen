...
public class EnchantCommonThrowItemAction extends CommonThrowItemAction implements IFailGuideUseActionContext {

    public static final ResourceLocation TYPE = VResourceLocation.ofMod("enchant_throw");

    public EnchantCommonThrowItemAction(EntityMaid maid, CraftGuideData craftGuideData, CraftGuideStepData craftGuideStepData, CraftLayer layer) {
