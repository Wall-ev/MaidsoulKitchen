...
public enum TaskInfo2 implements ITaskInfo<Mods> {
    /**
    ...
    YHC_FERMENTATION_TANK("yhc_fermentation_tank",
            ...
            true,
            Mods.YHCF),
    YHC_FERMENTATION_TANK_LEGACY(TaskInfo2.YHC_FERMENTATION_TANK, Mods.YHCD_LEGACY),
    ...
    KK_BREW_BARREL("kk_brew_barrel",
            ...
            Mods.KK_NEW,
            true),
    KK_BREW_BARREL_LEGACY(TaskInfo2.KK_BREW_BARREL, Mods.KK_LEGACY),
    @TaskModule(type = TaskModule.Type.KITCHEN_MODULE)
...
//    MSM_YHCF_KETTLE(MSM_YHC_KETTLE, Mods.YHCF),
    ...
    ;
    public static final TaskInfo2[] VALUES = values();
    public static final Codec<TaskInfo2> CODEC = EnumCodecUtil.fromEnum(() -> VALUES);
    ...
    private final List<TaskInfo2> dependTasks;
    private final List<Mods> dependMods;

    // -----------------------------------------------------------TaskInfo----------------------------------------------------------------//
    TaskInfo2(ResourceLocation uid, Mods bindMod, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, TaskInfo2... dependTasks) {
        this.uid = uid;
    ...
    TaskInfo2(ResourceLocation uid, Mods bindMod, TaskInfo2... dependTasks) {
        this.uid = uid;
        this.bindMod = bindMod;
    ...
    TaskInfo2(ResourceLocation uid, Mods bindMod, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, @Nullable Mods secondMod, TaskInfo2... dependTasks) {
        this.uid = uid;
        this.bindMod = bindMod;
        this.bindConfig = () -> bindConfig.get().get();
        this.dependTasks = List.of(dependTasks);
    ...
    TaskInfo2(ResourceLocation uid, Mods bindMod, @Nullable Mods secondMod, TaskInfo2... dependTasks) {
        this.uid = uid;
        this.bindMod = bindMod;
        this.bindConfig = () -> TaskRegisterConfig.enabled(this.uid);
        this.dependTasks = List.of(dependTasks);
    ...
    TaskInfo2(String oldName, String uid, Mods bindMod, boolean concatModId, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, TaskInfo2... dependTasks) {
    ...
    TaskInfo2(String oldName, String uid, Mods bindMod, boolean concatModId, TaskInfo2... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, uid, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> TaskRegisterConfig.enabled(this.uid);
    ...
    TaskInfo2(String oldName, String uid, Mods bindMod, boolean concatModId, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, @Nullable Mods secondMod, TaskInfo2... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, uid, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> bindConfig.get().get();
    ...
    TaskInfo2(String oldName, String uid, Mods bindMod, boolean concatModId, @Nullable Mods secondMod, TaskInfo2... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, uid, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> TaskRegisterConfig.enabled(this.uid);
    ...
    TaskInfo2(String oldName, String uid, Mods bindMod, boolean concatModId, Config bindConfig, TaskInfo2... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, uid, bindMod, concatModId);
        this.bindMod = bindMod;
    ...
    TaskInfo2(String oldName, String uid, Mods bindMod, boolean concatModId, Config bindConfig, @Nullable Mods secondMod, TaskInfo2... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, uid, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> bindConfig.canLoad();
    ...
    TaskInfo2(String oldName, String blockId, String recipeId, Mods bindMod, boolean concatModId, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, TaskInfo2... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
    ...
    TaskInfo2(String oldName, String blockId, String recipeId, Mods bindMod, boolean concatModId, TaskInfo2... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, blockId + "_" + recipeId, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> TaskRegisterConfig.enabled(this.uid);
    ...
    TaskInfo2(String oldName, String blockId, String recipeId, Mods bindMod, boolean concatModId, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, @Nullable Mods secondMod, TaskInfo2... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, blockId + "_" + recipeId, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> bindConfig.get().get();
    ...
    TaskInfo2(String oldName, String blockId, String recipeId, Mods bindMod, boolean concatModId, @Nullable Mods secondMod, TaskInfo2... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, blockId + "_" + recipeId, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> TaskRegisterConfig.enabled(this.uid);
    ...
    TaskInfo2(String oldName, String blockId, String recipeId, Mods bindMod, boolean concatModId, Config bindConfig, TaskInfo2... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, blockId + "_" + recipeId, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> bindConfig.canLoad();
    ...
    TaskInfo2(String oldName, String blockId, String recipeId, Mods bindMod, boolean concatModId, Config bindConfig, @Nullable Mods secondMod, TaskInfo2... dependTasks) {
        this.oldName = VResourceLocation.ofMod(oldName).toString();
        this.uid = convertUid(oldName, blockId + "_" + recipeId, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> bindConfig.canLoad();
    ...
    TaskInfo2(String uid, Mods bindMod, boolean concatModId, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, TaskInfo2... dependTasks) {
        this("", uid, bindMod, concatModId, bindConfig, dependTasks);
    }

    TaskInfo2(String uid, Mods bindMod, boolean concatModId, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, @Nullable Mods secondMod, TaskInfo2... dependTasks) {
        this("", uid, bindMod, concatModId, bindConfig, secondMod, dependTasks);
    }

    TaskInfo2(String uid, Mods bindMod, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, TaskInfo2... dependTasks) {
        this(uid, bindMod, false, bindConfig, dependTasks);
    }

    TaskInfo2(String uid, Mods bindMod, Supplier<ForgeConfigSpec.BooleanValue> bindConfig, @Nullable Mods secondMod, TaskInfo2... dependTasks) {
        this(uid, bindMod, false, bindConfig, secondMod, dependTasks);
    }

    TaskInfo2(String uid, Mods bindMod, boolean concatModId, Config bindConfig, TaskInfo2... dependTasks) {
        this.uid = convertUid(oldName, uid, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> bindConfig.canLoad();
        this.dependTasks = List.of(dependTasks);
    ...
    TaskInfo2(String uid, Mods bindMod, boolean concatModId, Config bindConfig, @Nullable Mods secondMod, TaskInfo2... dependTasks) {
        this.uid = convertUid(oldName, uid, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> bindConfig.canLoad();
        this.dependTasks = List.of(dependTasks);
    ...
    TaskInfo2(String uid, Mods bindMod, boolean concatModId, TaskInfo2... dependTasks) {
        this.uid = convertUid(oldName, uid, bindMod, concatModId);
        this.bindMod = bindMod;
    ...
    TaskInfo2(String uid, Mods bindMod, boolean concatModId, @Nullable Mods secondMod, TaskInfo2... dependTasks) {
        this.uid = convertUid(oldName, uid, bindMod, concatModId);
        this.bindMod = bindMod;
        this.bindConfig = () -> true;
        this.dependTasks = List.of(dependTasks);
    ...
    TaskInfo2(String uid, Mods bindMod, Config bindConfig, TaskInfo2... dependTasks) {
        this(uid, bindMod, false, bindConfig, dependTasks);
    }


    TaskInfo2(String uid, Mods bindMod, Config bindConfig, @Nullable Mods secondMod, TaskInfo2... dependTasks) {
        this(uid, bindMod, false, bindConfig, secondMod, dependTasks);
    }

    TaskInfo2(String uid, Mods bindMod, TaskInfo2... dependTasks) {
        this(uid, bindMod, false, dependTasks);
    }

    TaskInfo2(String uid, Mods bindMod, @Nullable Mods secondMod, TaskInfo2... dependTasks) {
     ...
     */
    TaskInfo2(TaskInfo2 parentTaskInfo, Mods legacyMod) {
...
//        return VResourceLocation.createMod(oldName);
    ...
    public static TaskInfo2 by(String key) {
        return TaskInfo2.valueOf(key);
    }

    @Nullable
    public static TaskInfo2 by(ResourceLocation taskUid) {
        for (TaskInfo2 value : TaskInfo2.values()) {
    ...
    public boolean dependCanLoad() {
        return this.dependTasks.stream().allMatch(TaskInfo2::canLoadWithoutCheckClazz) && this.dependMods.stream().allMatch(Mods::versionLoad);
    }
