package com.github.wallev.maidsoulkitchen.client.renderer.entity.layer.banner.vinery;
...
@TaskClassAnalyzer(TaskInfo.LAYER_VINERY)
@OnlyIn(Dist.CLIENT)
public class LayerVineryBannerRender implements IBannerRenderer {
