package com.github.wallev.maidsoulkitchen.client.renderer.entity.layer.banner.bakery;
...
@TaskClassAnalyzer(TaskInfo.LAYER_BAKERY)
@OnlyIn(Dist.CLIENT)
public class LayerBakeryBannerRender implements IBannerRenderer {
