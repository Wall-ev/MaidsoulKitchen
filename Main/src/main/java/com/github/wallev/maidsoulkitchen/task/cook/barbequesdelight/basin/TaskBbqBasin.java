...
import static com.github.wallev.maidsoulkitchen.api.task.cook.ICookTask.Index.BD_BASIN;

@AutoCookTaskRegister(TaskInfo.BD_BASIN)
...
public class TaskBbqBasin extends ICookTask<BasinBlockEntity, SkeweringRecipe<?>> {
    ...
    public ResourceLocation getUid() {
        return TaskInfo.BD_BASIN.getUid();
    }
