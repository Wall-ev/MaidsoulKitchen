...
public class EnchantCommonIdleAction extends CommonIdleAction implements IFailGuideUseActionContext {

    public static final ResourceLocation TYPE = VResourceLocation.ofMod("enchant_idle");

    public EnchantCommonIdleAction(EntityMaid maid, CraftGuideData craftGuideData, CraftGuideStepData craftGuideStepData, CraftLayer layer) {
