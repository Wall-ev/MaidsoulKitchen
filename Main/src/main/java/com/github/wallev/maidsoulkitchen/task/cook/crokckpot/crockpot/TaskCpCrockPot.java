...
import static com.github.wallev.maidsoulkitchen.api.task.cook.ICookTask.Index.CP_CROCK_POT;

@AutoCookTaskRegister(TaskInfo.CP_CROCK_POT)
...
public class TaskCpCrockPot extends ICookTask<CrockPotBlockEntity, CrockPotCookingRecipe> {
    ...
    public ResourceLocation getUid() {
        return TaskInfo.CP_CROCK_POT.getUid();
    }
